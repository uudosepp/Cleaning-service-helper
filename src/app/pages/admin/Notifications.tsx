  ...
  return (
    <div>
      <PageHeader
        ...
        actions={
          visuallyNewIds.size > 0 && (
            <Button variant="outline" size="sm" onClick={() => { setVisuallyNewIds(new Set()); handleMarkAllRead(); }}>
            ...
            return (
              <Card
                ...
                onClick={async () => {
                  ...
                  // Load task details if reference_id exists
                  if (n.reference_id) {
                    // Try with full joins first, fallback to simple query
                    let taskData = null;
                    ...
                    // If not found with RLS, try without joins
                    if (!taskData) {
                    ...
                    if (taskData) setSelectedTask(taskData as CleaningTask);
                  }
                }}
              >
